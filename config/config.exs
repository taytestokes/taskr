...
config :taskr, TaskrWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: TaskrWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: Taskr.PubSub,
  live_view: [signing_salt: "dFTArx79"]
...
config :taskr, Taskr.Mailer, adapter: Swoosh.Adapters.Local
